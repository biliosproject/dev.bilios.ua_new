<?php
// Heading
$_['heading_title']    				= '<span style="color:#1475C4;">NewStore</span> - Productany';

// Text
$_['text_module']      				= 'Модулі';
$_['text_success']     				= 'Налаштування змінені';
$_['text_edit']        				= 'Налаштування модуля';
$_['text_productany_title']        	= 'Назва модуля (на сайті)';
$_['entry_title_color_text']        = 'Колір тексту назви модуля на сайті';
$_['entry_title_background']        = 'Колір фону назви модуля на сайті';
