...
class ControllerRevolutionrevpbest extends Controller {
	public function index() {
		...
		if ($this->config->get('revtheme_meta')['best_meta_title'][(int)$this->config->get('config_language_id')]) {
			$this->document->setTitle($this->config->get('revtheme_meta')['best_meta_title'][(int)$this->config->get('config_language_id')]);
		} else {
			$this->document->setTitle($this->language->get('heading_title'));
		}
		if ($this->config->get('revtheme_meta')['best_meta_description'][(int)$this->config->get('config_language_id')]) {
			$this->document->setDescription($this->config->get('revtheme_meta')['best_meta_description'][(int)$this->config->get('config_language_id')]);
		}
		if ($this->config->get('revtheme_meta')['best_meta_keyword'][(int)$this->config->get('config_language_id')]) {
			$this->document->setKeywords($this->config->get('revtheme_meta')['best_meta_keyword'][(int)$this->config->get('config_language_id')]);
		}
		...
		if ($settings_best['best_products'] != '') {
			...
			$product_total = $this->model_revolution_revolution->getBestProductsTotal($filter_data);
		}
