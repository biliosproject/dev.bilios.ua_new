...
class ControllerStartupSeoUrl extends Controller {
	...
	public function rewrite($link) {
		...
		foreach ($data as $key => $value) {
			if (isset($data['route'])) {
				if (($data['route'] == 'product/product' && $key == 'product_id') || (($data['route'] == 'product/manufacturer/info' || $data['route'] == 'product/product') && $key == 'manufacturer_id') || ($data['route'] == 'revolution/revblog_blog' && $key == 'revblog_id') || ($data['route'] == 'revolution/revblog_category' && $key == 'revblog_category_id') || ($data['route'] == 'information/information' && $key == 'information_id')) {
