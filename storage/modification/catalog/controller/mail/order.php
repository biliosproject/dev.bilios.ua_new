	...
	public function add($order_info, $order_status_id, $comment, $notify) {
		...
		foreach ($order_products as $order_product) {
			...
			foreach ($order_options as $order_option) {
				...
				$option_data[] = array(
'model' => (isset($order_option['model']) ? $order_option['model'] : false),
			...
			$data['products'][] = array(
				...
				'model'    => $order_product['model'], 'sku' => $order_product['sku'], 'image' => $image, 'href' => $this->url->link('product/product', 'product_id=' . $order_product['order_product_id']),
				'option'   => $option_data,
