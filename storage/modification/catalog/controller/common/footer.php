		...
		$this->load->model('catalog/information');
				...
				if (!empty($revtheme_dop_menu_cf_2)){
					...
					foreach($data['revtheme_dop_menus_cf_2'] as $key => $val){
						if (!empty($data['revtheme_dop_menus_cf_2'][$key]['dop_menu_image_cf_2'])){
							$data['revtheme_dop_menus_cf_2'][$key]['dop_menu_image_cf_2'] = $this->model_tool_image->resize($data['revtheme_dop_menus_cf_2'][$key]['dop_menu_image_cf_2'], $img_cf_wh, $img_cf_wh);
						} else {
							$data['revtheme_dop_menus_cf_2'][$key]['dop_menu_image_cf_2'] = false;
						}
						if (isset($data['revtheme_dop_menus_cf_2'][$key]['children'])){
							$children = $data['revtheme_dop_menus_cf_2'][$key]['children'];
							foreach($children as $key2 => $val2){
								if (!empty($data['revtheme_dop_menus_cf_2'][$key]['children'][$key2]['dop_menu_image_cf_2'])){
									$data['revtheme_dop_menus_cf_2'][$key]['children'][$key2]['dop_menu_image_cf_2'] = $this->model_tool_image->resize($data['revtheme_dop_menus_cf_2'][$key]['children'][$key2]['dop_menu_image_cf_2'], $img_cf_wh, $img_cf_wh);
								} else {
									$data['revtheme_dop_menus_cf_2'][$key]['children'][$key2]['dop_menu_image_cf_2'] = false;
								}
							}
						}
					}
				...
				if (!empty($revtheme_dop_menu_cf_3)){
					...
					foreach($data['revtheme_dop_menus_cf_3'] as $key => $val){
						if (!empty($data['revtheme_dop_menus_cf_3'][$key]['dop_menu_image_cf_3'])){
							$data['revtheme_dop_menus_cf_3'][$key]['dop_menu_image_cf_3'] = $this->model_tool_image->resize($data['revtheme_dop_menus_cf_3'][$key]['dop_menu_image_cf_3'], $img_cf_wh, $img_cf_wh);
						} else {
							$data['revtheme_dop_menus_cf_3'][$key]['dop_menu_image_cf_3'] = false;
						}
						if (isset($data['revtheme_dop_menus_cf_3'][$key]['children'])){
							$children = $data['revtheme_dop_menus_cf_3'][$key]['children'];
							foreach($children as $key2 => $val2){
								if (!empty($data['revtheme_dop_menus_cf_3'][$key]['children'][$key2]['dop_menu_image_cf_3'])){
									$data['revtheme_dop_menus_cf_3'][$key]['children'][$key2]['dop_menu_image_cf_3'] = $this->model_tool_image->resize($data['revtheme_dop_menus_cf_3'][$key]['children'][$key2]['dop_menu_image_cf_3'], $img_cf_wh, $img_cf_wh);
								} else {
									$data['revtheme_dop_menus_cf_3'][$key]['children'][$key2]['dop_menu_image_cf_3'] = false;
								}
							}
						}
					}
				...
				if (!empty($revtheme_dop_menu_cf_4)){
					...
					foreach($data['revtheme_dop_menus_cf_4'] as $key => $val){
						if (!empty($data['revtheme_dop_menus_cf_4'][$key]['dop_menu_image_cf_4'])){
							$data['revtheme_dop_menus_cf_4'][$key]['dop_menu_image_cf_4'] = $this->model_tool_image->resize($data['revtheme_dop_menus_cf_4'][$key]['dop_menu_image_cf_4'], $img_cf_wh, $img_cf_wh);
						} else {
							$data['revtheme_dop_menus_cf_4'][$key]['dop_menu_image_cf_4'] = false;
						}
						if (isset($data['revtheme_dop_menus_cf_4'][$key]['children'])){
							$children = $data['revtheme_dop_menus_cf_4'][$key]['children'];
							foreach($children as $key2 => $val2){
								if (!empty($data['revtheme_dop_menus_cf_4'][$key]['children'][$key2]['dop_menu_image_cf_4'])){
									$data['revtheme_dop_menus_cf_4'][$key]['children'][$key2]['dop_menu_image_cf_4'] = $this->model_tool_image->resize($data['revtheme_dop_menus_cf_4'][$key]['children'][$key2]['dop_menu_image_cf_4'], $img_cf_wh, $img_cf_wh);
								} else {
									$data['revtheme_dop_menus_cf_4'][$key]['children'][$key2]['dop_menu_image_cf_4'] = false;
								}
							}
						}
					}
				...
				if (!empty($revtheme_dop_menu_cf_5)){
					...
					foreach($data['revtheme_dop_menus_cf_5'] as $key => $val){
						if (!empty($data['revtheme_dop_menus_cf_5'][$key]['dop_menu_image_cf_5'])){
							$data['revtheme_dop_menus_cf_5'][$key]['dop_menu_image_cf_5'] = $this->model_tool_image->resize($data['revtheme_dop_menus_cf_5'][$key]['dop_menu_image_cf_5'], $img_cf_wh, $img_cf_wh);
						} else {
							$data['revtheme_dop_menus_cf_5'][$key]['dop_menu_image_cf_5'] = false;
						}
						if (isset($data['revtheme_dop_menus_cf_5'][$key]['children'])){
							$children = $data['revtheme_dop_menus_cf_5'][$key]['children'];
							foreach($children as $key2 => $val2){
								if (!empty($data['revtheme_dop_menus_cf_5'][$key]['children'][$key2]['dop_menu_image_cf_5'])){
									$data['revtheme_dop_menus_cf_5'][$key]['children'][$key2]['dop_menu_image_cf_5'] = $this->model_tool_image->resize($data['revtheme_dop_menus_cf_5'][$key]['children'][$key2]['dop_menu_image_cf_5'], $img_cf_wh, $img_cf_wh);
								} else {
									$data['revtheme_dop_menus_cf_5'][$key]['children'][$key2]['dop_menu_image_cf_5'] = false;
								}
							}
						}
					}
