	...
	public function add() {
		...
		if ($product_info) {
			...
			if (!$json) {
				...
				$json['redirect_cart'] = $this->url->link(isset($this->config->get('revtheme_all_settings')['revcheckout_status']) && $this->config->get('revtheme_all_settings')['revcheckout_status'] ? 'revolution/revcheckout' : 'checkout/checkout'
			);
