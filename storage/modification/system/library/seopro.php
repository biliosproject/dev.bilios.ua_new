            ...
            foreach($parts as $id => $part) {
                ...
                if($parts[$id]) {
                    ...
                    if(!empty($url[0])) {
                        ...
                        if(!in_array($url[0], ['category_id', 'product_id', 'manufacturer_id', 'information_id', 'article_id', 'blog_category_id', 'revblog_category_id', 'revblog_id'])) {
                            return $parts;
                        }
